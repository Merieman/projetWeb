...
<head>
  ...
  <link rel="stylesheet" href="loginprojet.css">
</head>
<body>
<form method="post" action="verifiecollaborateur.php">
<div id="stars"></div>
<div id="stars2"></div>
<div id="stars3"></div>
<div class="section">
                ...
                <div class="center-wrap">
                  <div class="section text-center">
                    ...
                    <div class="form-group">
                      <input type="email" class="form-style" name="username" placeholder="Email">
